...
export const PRODUCTS = [
  ...
  },
  {
    ...
    price: 1999,
    tag: "Bestseller",
    desc: "Tapered cargos with a clean silhouette, deep pockets, and a comfy waistband.",
  ...
  },
  {
    ...
    price: 2899,
    tag: "Icon",
    desc: "Modern denim with a structured shoulder, soft wash, and crisp seams that elevates.",
    sizes: ["S", "M", "L", "XL"],
    color: "Washed Indigo",
  ...
  },
  {
    ...
    price: 1799,
    tag: "Elegant",
    desc: "Flowy pleats with a sleek waistband—designed to move beautifull.",
    sizes: ["XS", "S", "M", "L"],
    color: "Obsidian",
  ...
  },
  {
    ...
    price: 1899,
    tag: "Cozy",
    desc: "A soft cardigan with a luxe fall, slightly oversized sleeves, and a smooth texture.",
    sizes: ["S", "M", "L", "XL"],
    color: "Warm Sand",
    img: "assets/img/jacket.webp",
  ...
  },
  {
    ...
    price: 3299,
    tag: "Night",
    desc: "Satin finish with a clean neckline and subtle made for evenings and standout moments.",
    sizes: ["XS", "S", "M", "L"],
    color: "Midnight",
